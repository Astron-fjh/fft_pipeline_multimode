...
HD_PWD='E:/Vivado/fft_pipeline_multimode/fft_pipeline_multimode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_multimode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_multimode.tcl

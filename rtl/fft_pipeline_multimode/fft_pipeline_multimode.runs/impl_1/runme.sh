...
HD_PWD='E:/Vivado/fft_pipeline_multimode/fft_pipeline_multimode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_multimode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_multimode.tcl -notrace
